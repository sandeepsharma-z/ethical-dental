    ...
    <footer className="bg-foreground text-background/70">
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 lg:col-span-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display text-xl font-semibold text-background">ETHICAL DENTAL | Dr. Siddharth Garg | Best Dental clinic in North Delhi -Rohini</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>011 4141 0494</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail size={16} className="shrink-0 text-primary" />
                <span>contact@ethicaldental.in</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-background/10 mt-12 pt-8 text-center text-sm">
          <p>Copyright 2026 ETHICAL DENTAL | Dr. Siddharth Garg | Best Dental clinic in North Delhi -Rohini. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
