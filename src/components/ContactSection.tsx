        ...
        <div className={`grid lg:grid-cols-2 gap-10 ${isVisible ? "animate-reveal-up" : "opacity-0"}`}>
          ...
          <div className="space-y-6">
            {[
              ...
              { icon: Phone, label: "Phone", value: "011 4141 0494" },
              { icon: Mail, label: "Email", value: "contact@ethicaldental.in" },
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl bg-muted h-72 lg:h-auto min-h-[320px]">
            <iframe
              title="ETHICAL DENTAL | Dr. Siddharth Garg | Best Dental clinic in North Delhi -Rohini Location"
