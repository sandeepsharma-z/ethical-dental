...
const botReply = (input: string) => {
  ...
  if (/(hi|hello|salam|assalam|hey)/.test(q)) {
    return "Hello! Main ETHICAL DENTAL | Dr. Siddharth Garg | Best Dental clinic in North Delhi -Rohini assistant hoon. Aap implant, pain, braces, cleaning, timing ya booking ke baare me pooch sakte hain.";
  }
  ...
  if (/(pain|dard|toothache|sujaan|swelling)/.test(q)) {
    return "Agar severe pain ya swelling ho to delay mat karein. Garam-thanda avoid karein aur emergency checkup ke liye clinic visit karein ya call karein: 011 4141 0494.";
  }
  ...
  if (/(appointment|book|booking|schedule)/.test(q)) {
    return "Appointment ke liye page par Book Now form fill karein ya direct call karein: 011 4141 0494.";
  }
  ...
  if (/(emergency|urgent|bleeding|broken tooth)/.test(q)) {
    return "Emergency case me foran contact karein: 011 4141 0494. Hum urgent dental pain, fracture aur infection cases handle karte hain.";
  }
